 ...
 */
public class RobotRace15 extends Base {
    ...
    class Robot {
        ...
        float speed = 1f; //specifies the speed at which yPos is increased
        final static private float MAXANGLE = 30; //specifies the maximum angle
         ...
         */
        public Robot() {
            this(0.5f, 0.5f,0.5f,0.5f,0.5f, 0.5f,0.75f,0.1f,0.1f);
        }
        ...
        public class LegsPart implements RobotPart {
            ...
            LegPart leftLeg; //object for left leg
            LegPart rightLeg; //object for right leg
