 ...
 */
public class RobotRace13 extends Base {
    ...
    public void drawScene() {
        ...
        //draw robots
        gl.glPushMatrix();
        gl.glTranslatef(-NUMROBOTS / 2, 0, 0);
        for (Robot r : robots) {
        ...
        public class LegPart implements RobotPart {
            ...
            public void draw() {
                ...
                if (gs.showStick) {
                    ...
                    gl.glVertex3d(s * sqrt(parent.length * parent.length - getHeight() * getHeight()), 0, 0);
                    gl.glEnd();
                } else {
                    gl.glPushMatrix();
    ...
    for(int i = 0; i < 100; i++) {
        ...
        gl.glVertex3d(0,x + (cos(angle) * radius), y + (sin(angle) * radius));
    }
    gl.glEnd();
                } else {
                    gl.glPushMatrix();
